...
const List = ({ token }) => {
  ...
  const fetchList = async () => {
    try {
      const response = await axios.get('https://forever-e-commerce-backend.onrender.com/api/product/list');
  ...
  const removeProduct = async (id) => {
    try {
      const response = await axios.post('https://forever-e-commerce-backend.onrender.com/api/product/remove', { id }, { headers: { token } });
      if (response.data.success) {
